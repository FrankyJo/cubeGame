...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return cubeGame; });
...
var cubeGame = /*#__PURE__*/function () {
  function cubeGame() {
    var lengthCube = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '10';
    var widthCube = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '30';
    var heightCube = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '30';
    var colorCube = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '#ff5722';
    var timeGame = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : '60';

    _classCallCheck(this, cubeGame);
    ...
    this.time = timeGame;
    this.modalWindow = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modal-result');
  ...
  _createClass(cubeGame, [{
    ...
    value: function createCube() {
      var style = "\n        position: absolute;\n        top: ".concat(this.randomizer(0, this.playingFieldHeight - this.widthCube), "px;\n        left: ").concat(this.randomizer(0, this.playingFieldWidth - this.heightCube), "px;\n        width: ").concat(this.widthCube, "px;\n        height: ").concat(this.heightCube, "px;\n        background-color: ").concat(this.color, "\n      ");
      return this.createElement('div', 'cube', style);
    }
  }, {
    key: "createNewCubes",
    value: function createNewCubes() {
      var countCube = this.randomizer(0, 2);

      for (var i = 1; i <= countCube; i++) {
        var cube = this.createCube();
        this.playingField.appendChild(cube);
      }
    }
  }, {
    key: "startCubesOnField",
    value: function startCubesOnField(length) {
    ...
    value: function listener() {
      ...
      this.start.addEventListener('click', function () {
        _this.startCubesOnField(_this.CubesOnField);

        _this.start.setAttribute('disabled', '');
      ...
      this.newGame.addEventListener('click', function () {
        ...
        _this.pointsInput.value = 0;
        _this.points = 0;

        _this.start.removeAttribute('disabled');
      });
      this.playingField.addEventListener('click', function (el) {
        var target = el.target;

        if (target.classList.contains('cube')) {
          _this.points++;
          _this.pointsInput.value = _this.points;
          target.remove();

          _this.createNewCubes();
        }
      });
      this.buttonSaveResult.addEventListener('click', function () {
        _this.modalWindow.modal('hide');

        _this.saveResult();

        _this.showResult();
      });
      this.modalWindow.on('show.bs.modal', function () {
        _this.scoreInModal.innerHTML = _this.pointsInput.value;
      });
    }
  }, {
    key: "timer",
    ...
    value: function cleanTimer() {
      var timerId = sessionStorage.getItem('timerID');
    ...
    value: function saveResult() {
      var result = sessionStorage.getItem('result') ? JSON.parse(sessionStorage.getItem('result')) : [];
    ...
    value: function showResult() {
      ...
      if (result) {
        for (var i = 1; i < result.length; i++) {
          var li = this.createElement('li', 'list-group-item');
          li.innerHTML = "".concat(result[i].name, " - ").concat(result[i].points, " points");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _game__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./game */ "./app/src/js/game.js");
